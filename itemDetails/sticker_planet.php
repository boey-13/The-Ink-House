...
<head>
    ...
    <script>
		let images = [
			"../item images/sticker image/200pcs Exotic Planet Sticker Set/1.webp",
			"../item images/sticker image/200pcs Exotic Planet Sticker Set/2.jpeg",
			"../item images/sticker image/200pcs Exotic Planet Sticker Set/3.jpeg",
			"../item images/sticker image/200pcs Exotic Planet Sticker Set/4.jpeg"
		];
	...
	<script>
		...
		function loadReviews() {
			...
			const savedReviews = JSON.parse(localStorage.getItem('planetSticker_reviews')) || [];
		...
		function saveReview(reviewHTML) {
			...
			localStorage.setItem('planetSticker_reviews', JSON.stringify(savedReviews));
		}
    ...
    <div class="container">
        <div class="item-images">
            ...
            <div class="thumbnails">
                <img class="thumbnail" src="../item images/sticker image/200pcs Exotic Planet Sticker Set/1.webp" alt="Thumbnail 1" onclick="selectImage(0)">
                <img class="thumbnail" src="../item images/sticker image/200pcs Exotic Planet Sticker Set/2.jpeg" alt="Thumbnail 2" onclick="selectImage(1)">
                <img class="thumbnail" src="../item images/sticker image/200pcs Exotic Planet Sticker Set/3.jpeg" alt="Thumbnail 3" onclick="selectImage(2)">
                <img class="thumbnail" src="../item images/sticker image/200pcs Exotic Planet Sticker Set/4.jpeg" alt="Thumbnail 4" onclick="selectImage(3)">
            </div>
		
			<!-- Main image -->
			<div class="main-image">
				<img id="main-image" src="../item images/sticker image/200pcs Exotic Planet Sticker Set/1.webp" alt="item-image" class="item-image" onclick="openModal()">
        ...
        <div class="item-info">
            <h1>200pcs Exotic Planet Sticker Set</h1>
            <div class="price">RM 10.80</div>
            <div class="discounted-price">RM 9.66</div>
            ...
            <div class="item-options">
                ...
                <div class="row">
                    ...
                    <div class="options" id="options">
                        <img id="1" src="../item images/sticker image/200pcs Exotic Planet Sticker Set/3.jpeg" alt="1" data-color="One variation" data-variant-id="48"
                            onclick="changeImage('../item images/sticker image/200pcs Exotic Planet Sticker Set/3.jpeg', 'One variation')">
                    </div>
			...
			<br>
            <button class="add-to-cart">ADD TO CART | RM 9.66</button>
			<br><br>
            <div class="info-tabs">
            ...
            <div class="info-content">
                <div id="description-column" class="info-column">
                    ...
                    <ul>
                        <li> Material：Self-adhesive sticker </li>
                        <li> Quantity：200 </li>
                        <li> Size：145x95mm </li>
                        <li> Use：Decoration，stationery，notebook ，mobile phone，book，hand account book </li>
                    </ul>
                </div>
