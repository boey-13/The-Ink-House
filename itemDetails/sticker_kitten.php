...
<head>
    ...
    <script>
		let images = [
			"../item images/sticker image/60pcs Cute Kittens Cats MEME Waterproof Stickers/1.jpeg",
			"../item images/sticker image/60pcs Cute Kittens Cats MEME Waterproof Stickers/2.jpeg",
			"../item images/sticker image/60pcs Cute Kittens Cats MEME Waterproof Stickers/3.jpeg",
			"../item images/sticker image/60pcs Cute Kittens Cats MEME Waterproof Stickers/4.jpeg",
			"../item images/sticker image/60pcs Cute Kittens Cats MEME Waterproof Stickers/A.jpeg",
			"../item images/sticker image/60pcs Cute Kittens Cats MEME Waterproof Stickers/B.jpeg"
		];
	...
	<script>
		...
		function loadReviews() {
			...
			const savedReviews = JSON.parse(localStorage.getItem('kittenSticker_reviews')) || [];
		...
		function saveReview(reviewHTML) {
			...
			localStorage.setItem('kittenSticker_reviews', JSON.stringify(savedReviews));
		}
...
<body>
    ...
    <div class="container">
        <div class="item-images">
            ...
            <div class="thumbnails">
                <img class="thumbnail" src="../item images/sticker image/60pcs Cute Kittens Cats MEME Waterproof Stickers/1.jpeg" alt="Thumbnail 1" onclick="selectImage(0)">
                <img class="thumbnail" src="../item images/sticker image/60pcs Cute Kittens Cats MEME Waterproof Stickers/2.jpeg" alt="Thumbnail 2" onclick="selectImage(1)">
                <img class="thumbnail" src="../item images/sticker image/60pcs Cute Kittens Cats MEME Waterproof Stickers/3.jpeg" alt="Thumbnail 3" onclick="selectImage(2)">
                <img class="thumbnail" src="../item images/sticker image/60pcs Cute Kittens Cats MEME Waterproof Stickers/A.jpeg" alt="Thumbnail 4" onclick="selectImage(3)">
                <img class="thumbnail" src="../item images/sticker image/60pcs Cute Kittens Cats MEME Waterproof Stickers/B.jpeg" alt="Thumbnail 5" onclick="selectImage(4)">
            </div>
		
			<!-- Main image -->
			<div class="main-image">
				<img id="main-image" src="../item images/sticker image/60pcs Cute Kittens Cats MEME Waterproof Stickers/1.jpeg" alt="item-image" class="item-image" onclick="openModal()">
        ...
        <div class="item-info">
            <h1>60pcs Cute Kittens Cats MEME Waterproof Stickers </h1>
            <div class="price">RM 3.90</div>
            <div class="discounted-price">RM 3.32</div>
            ...
            <div class="item-options">
                ...
                <div class="row">
                    ...
                    <div class="options" id="options">
                        <img id="A" src="../item images/sticker image/60pcs Cute Kittens Cats MEME Waterproof Stickers/A.jpeg" alt="A" data-color="A" data-variant-id="49"
                            onclick="changeImage('../item images/sticker image/60pcs Cute Kittens Cats MEME Waterproof Stickers/A.jpeg', 'A')">
						<img id="B" src="../item images/sticker image/60pcs Cute Kittens Cats MEME Waterproof Stickers/B.jpeg" alt="B" data-color="B" data-variant-id="50"
                            onclick="changeImage('../item images/sticker image/60pcs Cute Kittens Cats MEME Waterproof Stickers/B.jpeg', 'B')">
                    </div>
			...
			<br>
            <button class="add-to-cart">ADD TO CART | RM 3.32</button>
			<br><br>
            <div class="info-tabs">
            ...
            <div class="info-content">
                <div id="description-column" class="info-column">
                    ...
                    <ul>
                        ...
                        <li> Waterproof, no need for trimming</li>
                        <li> The packaging includes graffiti stickers and bombs </li>
                        <li> Suitable for: laptops, graffiti, classics, stickers, skis, cars, buffer zones</li>
                        <li> Sunscreen and waterproof! Never fade! </li>
                        <li> Size: About 3-6cm </li>
                        <li> Package: 1/60Sheets Stickers </li>
                        <li> Material: PVC </li>
                    </ul>
                </div>
	...
	<section class="products" id="products">
		...
		<div class="box-container">
			...
			<div class="box">
				<div class="image">
					<img src="../item images/sticker image/50pcs minimalist art ins style black and white stickers/1.jpg" alt="sticker" >
					<div class="icons">
						<a href="../itemDetails/sticker_minimalist art.php" class="view" onclick="redirectTo('sticker_minimalist art.php')">View Detail</a>
					</div>
				</div>
			<div class="content">
