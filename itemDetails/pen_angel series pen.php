...
<head>
    ...
    <script>
		let images = [
			"../item images/pen image/Ohaya Mura White Angel Series Pen/1.jpeg",
			"../item images/pen image/Ohaya Mura White Angel Series Pen/2.jpeg",
			"../item images/pen image/Ohaya Mura White Angel Series Pen/3.jpeg",
			"../item images/pen image/Ohaya Mura White Angel Series Pen/4.jpeg"
	...
	<script>
		...
		function loadReviews() {
			...
			const savedReviews = JSON.parse(localStorage.getItem('angelPen_reviews')) || [];
		...
		function saveReview(reviewHTML) {
			...
			localStorage.setItem('angelPen_reviews', JSON.stringify(savedReviews));
		}
    ...
    <div class="container">
        <div class="item-images">
            ...
            <div class="thumbnails">
                <img class="thumbnail" src="../item images/pen image/Ohaya Mura White Angel Series Pen/1.jpeg" alt="Thumbnail 1" onclick="selectImage(0)">
                <img class="thumbnail" src="../item images/pen image/Ohaya Mura White Angel Series Pen/2.jpeg" alt="Thumbnail 2" onclick="selectImage(1)">
                <img class="thumbnail" src="../item images/pen image/Ohaya Mura White Angel Series Pen/3.jpeg" alt="Thumbnail 3" onclick="selectImage(2)">
                <img class="thumbnail" src="../item images/pen image/Ohaya Mura White Angel Series Pen/4.jpeg" alt="Thumbnail 4" onclick="selectImage(3)">
            </div>
		
			<!-- Main image -->
			<div class="main-image">
				<img id="main-image" src="../item images/pen image/Ohaya Mura White Angel Series Pen/1.jpeg" alt="item-image" class="item-image" onclick="openModal()">
        ...
        <div class="item-info">
            <h1>Ohaya Mura White Angel Series Pen</h1>
            <div class="price">RM 2.40</div>
            <div class="discounted-price">RM 1.50</div>
            ...
            <div class="item-options">
                ...
                <div class="row">
                    ...
                    <div class="options" id="options">
                        <img id="random" src="../item images/pen image/Ohaya Mura White Angel Series Pen/1.jpeg" alt="random" data-color="random" data-variant-id="30"
                            onclick="changeImage('../item images/pen image/Ohaya Mura White Angel Series Pen/1.jpeg', 'random')">
                    </div>
			...
			<br>
            <button class="add-to-cart">ADD TO CART | RM 1.50</button>
			<br><br>
            <div class="info-tabs">
            ...
            <div class="info-content">
                <div id="description-column" class="info-column">
                    <h3>Description:</h3>
                    <ul>
                        <li> Buy One Pen Random Delivery </li>
                        <li> Buy Six And Get A Set </li>
                        <li> Super Nice, It Is Recommended To Place An Order </li>
                    </ul>
                </div>
