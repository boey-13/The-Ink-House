...
<head>
    ...
    <script>
		let images = [
			"../item images/notebook image/Snoopy notebook/1.jpg",
			"../item images/notebook image/Snoopy notebook/2.jpeg",
			"../item images/notebook image/Snoopy notebook/3.jpeg",
			"../item images/notebook image/Snoopy notebook/4.jpeg",
			"../item images/notebook image/Snoopy notebook/A.jpeg",
			"../item images/notebook image/Snoopy notebook/B.jpeg"
		];
	...
	<script>
		...
		function loadReviews() {
			...
			const savedReviews = JSON.parse(localStorage.getItem('snoopyNotebook_reviews')) || [];
		...
		function saveReview(reviewHTML) {
			...
			localStorage.setItem('snoopyNotebook_reviews', JSON.stringify(savedReviews));
		}
    ...
    <div class="container">
        <div class="item-images">
            ...
            <div class="thumbnails">
                <img class="thumbnail" src="../item images/notebook image/Snoopy notebook/1.jpg" alt="Thumbnail 1" onclick="selectImage(0)">
                <img class="thumbnail" src="../item images/notebook image/Snoopy notebook/2.jpeg" alt="Thumbnail 2" onclick="selectImage(1)">
                <img class="thumbnail" src="../item images/notebook image/Snoopy notebook/3.jpeg" alt="Thumbnail 3" onclick="selectImage(2)">
                <img class="thumbnail" src="../item images/notebook image/Snoopy notebook/4.jpeg" alt="Thumbnail 4" onclick="selectImage(3)">
                <img class="thumbnail" src="../item images/notebook image/Snoopy notebook/A.jpeg" alt="Thumbnail 5" onclick="selectImage(4)">
                <img class="thumbnail" src="../item images/notebook image/Snoopy notebook/B.jpeg" alt="Thumbnail 6" onclick="selectImage(5)">
            </div>
		
			<!-- Main image -->
			<div class="main-image">
				<img id="main-image" src="../item images/notebook image/Snoopy notebook/1.jpg" alt="item-image" class="item-image" onclick="openModal()">
        ...
        <div class="item-info">
            <h1>Snoopy Square Notebook </h1>
            <div class="price">RM 9.00</div>
            <div class="discounted-price">RM 6.88</div>
            ...
            <div class="item-options">
                ...
                <div class="row">
                    ...
                    <div class="options" id="options">
                        <img id="A" src="../item images/notebook image/Snoopy notebook/A.jpeg" alt="A" data-color="A" data-variant-id="12"
                            onclick="changeImage('../item images/notebook image/Snoopy notebook/A.jpeg', 'A')">
                        <img id="B" src="../item images/notebook image/Snoopy notebook/B.jpeg" alt="B" data-color="B" data-variant-id="13"
                            onclick="changeImage('../item images/notebook image/Snoopy notebook/B.jpeg', 'B')">
                    </div>
			...
			<br>
            <button class="add-to-cart">ADD TO CART | RM 6.88</button>
			<br><br>
            <div class="info-tabs">
            ...
            <div class="info-content">
                <div id="description-column" class="info-column">
                    <h3>Description:</h3>
                    <p>Snoopy Square Notebook | 100 Sheets Square Notebook</p>
                    <ul>
                        <li> Size: 183*130mm</li>
                        <li> Page: 80 sheet </li>
					</ul>
                        <p> Note: </p>
					<ol>
                        <li> The above products are semi-handmade, and there will be slight differences between the products and the publicity pictures. Examples: color, pattern, shape, size, small black spots, inconspicuous depressions, etc. </li>
                        <li> All sizes and measurements are not 100% accurate, please allow 1-2cm differences due to manual measurement. </li>
                    </ol>
                </div>
