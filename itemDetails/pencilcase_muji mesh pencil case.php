...
<head>
    ...
    <script>
		let images = [
			"../item images/pencil case image/Ins MUJI Mesh Pencil Case/1.webp",
			"../item images/pencil case image/Ins MUJI Mesh Pencil Case/2.jpeg",
			"../item images/pencil case image/Ins MUJI Mesh Pencil Case/3.jpeg",
			"../item images/pencil case image/Ins MUJI Mesh Pencil Case/4.jpeg",
			"../item images/pencil case image/Ins MUJI Mesh Pencil Case/black.jpeg",
			"../item images/pencil case image/Ins MUJI Mesh Pencil Case/darkgrey.jpeg",
			"../item images/pencil case image/Ins MUJI Mesh Pencil Case/white.jpeg"
		];
	...
	<script>
		...
		function loadReviews() {
			...
			const savedReviews = JSON.parse(localStorage.getItem('mujiMeshPenCase_reviews')) || [];
		...
		function saveReview(reviewHTML) {
			...
			localStorage.setItem('mujiMeshPenCase_reviews', JSON.stringify(savedReviews));
		}
    ...
    <div class="container">
        <div class="item-images">
            ...
            <div class="thumbnails">
                <img class="thumbnail" src="../item images/pencil case image/Ins MUJI Mesh Pencil Case/1.webp" alt="Thumbnail 1" onclick="selectImage(0)">
                <img class="thumbnail" src="../item images/pencil case image/Ins MUJI Mesh Pencil Case/2.jpeg" alt="Thumbnail 2" onclick="selectImage(1)">
                <img class="thumbnail" src="../item images/pencil case image/Ins MUJI Mesh Pencil Case/3.jpeg" alt="Thumbnail 3" onclick="selectImage(2)">
                <img class="thumbnail" src="../item images/pencil case image/Ins MUJI Mesh Pencil Case/4.jpeg" alt="Thumbnail 4" onclick="selectImage(3)">
                <img class="thumbnail" src="../item images/pencil case image/Ins MUJI Mesh Pencil Case/black.jpeg" alt="Thumbnail 5" onclick="selectImage(4)">
                <img class="thumbnail" src="../item images/pencil case image/Ins MUJI Mesh Pencil Case/darkgrey.jpeg" alt="Thumbnail 6" onclick="selectImage(5)">
                <img class="thumbnail" src="../item images/pencil case image/Ins MUJI Mesh Pencil Case/white.jpeg" alt="Thumbnail 7" onclick="selectImage(6)">
            </div>
		
			<!-- Main image -->
			<div class="main-image">
				<img id="main-image" src="../item images/pencil case image/Ins MUJI Mesh Pencil Case/1.webp" alt="item-image" class="item-image" onclick="openModal()">
        ...
        <div class="item-info">
            <h1>Ins MUJI Mesh Pencil Case</h1>
            <div class="price">RM 10.99</div>
            <div class="discounted-price">RM 7.69</div>
            ...
            <div class="item-options">
                ...
                <div class="row">
                    ...
                    <div class="options" id="options">
                        <img id="black" src="../item images/pencil case image/Ins MUJI Mesh Pencil Case/black.jpeg" alt="black" data-color="Black" data-variant-id="43"
                            onclick="changeImage('../item images/pencil case image/Ins MUJI Mesh Pencil Case/black.jpeg', 'Black')">
						<img id="darkgrey" src="../item images/pencil case image/Ins MUJI Mesh Pencil Case/darkgrey.jpeg" alt="darkgrey" data-color="Dark Grey" data-variant-id="44"
                            onclick="changeImage('../item images/pencil case image/Ins MUJI Mesh Pencil Case/darkgrey.jpeg', 'Dark Grey')">
						<img id="white" src="../item images/pencil case image/Ins MUJI Mesh Pencil Case/white.jpeg" alt="white" data-color="White" data-variant-id="42"
                            onclick="changeImage('../item images/pencil case image/Ins MUJI Mesh Pencil Case/white.jpeg', 'White')">
                    </div>
			...
			<br>
            <button class="add-to-cart">ADD TO CART | RM 7.69</button>
			<br><br>
            <div class="info-tabs">
            ...
            <div class="info-content">
                <div id="description-column" class="info-column">
                    ...
                    <ul>
                        <li> Simple, strong, and flexible see-through nylon design </li>
                        <li> Multi-purpose use for stationery, cosmetics, etc </li>
                        <li> Lightweight and compact for easy portability </li>
                        <li> Durable zipper closure to secure your belongings </li>
                        <li> Easy-to-clean surface for hassle-free maintenance </li>
