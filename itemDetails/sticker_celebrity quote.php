...
<head>
    ...
    <script>
		let images = [
			"../item images/sticker image/80 Pcs Retro Memo Paper Celebrity Quotes Graffiti Waterproof Stickers/1.jpg",
			"../item images/sticker image/80 Pcs Retro Memo Paper Celebrity Quotes Graffiti Waterproof Stickers/2.jpeg",
			"../item images/sticker image/80 Pcs Retro Memo Paper Celebrity Quotes Graffiti Waterproof Stickers/3.jpeg",
			"../item images/sticker image/80 Pcs Retro Memo Paper Celebrity Quotes Graffiti Waterproof Stickers/4.jpeg",
			"../item images/sticker image/80 Pcs Retro Memo Paper Celebrity Quotes Graffiti Waterproof Stickers/5.jpeg"
		];
	...
	<script>
		...
		function loadReviews() {
			...
			const savedReviews = JSON.parse(localStorage.getItem('quoteSticker_reviews')) || [];
		...
		function saveReview(reviewHTML) {
			...
			localStorage.setItem('quoteSticker_reviews', JSON.stringify(savedReviews));
		}
    ...
    <div class="container">
        <div class="item-images">
            ...
            <div class="thumbnails">
                <img class="thumbnail" src="../item images/sticker image/80 Pcs Retro Memo Paper Celebrity Quotes Graffiti Waterproof Stickers/1.jpg" alt="Thumbnail 1" onclick="selectImage(0)">
                <img class="thumbnail" src="../item images/sticker image/80 Pcs Retro Memo Paper Celebrity Quotes Graffiti Waterproof Stickers/2.jpeg" alt="Thumbnail 2" onclick="selectImage(1)">
                <img class="thumbnail" src="../item images/sticker image/80 Pcs Retro Memo Paper Celebrity Quotes Graffiti Waterproof Stickers/3.jpeg" alt="Thumbnail 3" onclick="selectImage(2)">
                <img class="thumbnail" src="../item images/sticker image/80 Pcs Retro Memo Paper Celebrity Quotes Graffiti Waterproof Stickers/4.jpeg" alt="Thumbnail 4" onclick="selectImage(3)">
                <img class="thumbnail" src="../item images/sticker image/80 Pcs Retro Memo Paper Celebrity Quotes Graffiti Waterproof Stickers/5.jpeg" alt="Thumbnail 5" onclick="selectImage(4)">
            </div>
		
			<!-- Main image -->
			<div class="main-image">
				<img id="main-image" src="../item images/sticker image/80 Pcs Retro Memo Paper Celebrity Quotes Graffiti Waterproof Stickers/1.jpg" alt="item-image" class="item-image" onclick="openModal()">
        ...
        <div class="item-info">
            <h1>80 Pcs Retro Memo Paper Celebrity Quotes Graffiti Waterproof Stickers</h1>
            <div class="price">RM 5.80</div>
            <div class="discounted-price">RM 4.20</div>
            ...
            <div class="item-options">
                ...
                <div class="row">
                    ...
                    <div class="options" id="options">
                        <img id="1" src="../item images/sticker image/80 Pcs Retro Memo Paper Celebrity Quotes Graffiti Waterproof Stickers/2.jpeg" alt="1" data-color="One variation" data-variant-id="51"
                            onclick="changeImage('../item images/sticker image/80 Pcs Retro Memo Paper Celebrity Quotes Graffiti Waterproof Stickers/2.jpeg', 'One variation')">
                    </div>
			...
			<br>
            <button class="add-to-cart">ADD TO CART | RM 4.20</button>
			<br><br>
            <div class="info-tabs">
            ...
            <div class="info-content">
                <div id="description-column" class="info-column">
                    ...
                    <ul>
                        <li> Size: 4-7cm </li>
                        <li> Quantity: 80 pcs/sticker </li>
                        <li> Material: waterproof</li>
                        <li> Sun protection and Waterproof  </li>
