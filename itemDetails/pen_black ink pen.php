...
<head>
    ...
    <script>
		let images = [
			"../item images/pen image/MUJI 0.5mm Smooth Black Ink Pen/1.jpeg",
			"../item images/pen image/MUJI 0.5mm Smooth Black Ink Pen/2.jpeg",
			"../item images/pen image/MUJI 0.5mm Smooth Black Ink Pen/3.jpeg",
			"../item images/pen image/MUJI 0.5mm Smooth Black Ink Pen/4.jpeg"
	...
	<script>
		...
		function loadReviews() {
			...
			const savedReviews = JSON.parse(localStorage.getItem('blackInkPen_reviews')) || [];
    ...
    <div class="container">
        <div class="item-images">
            ...
            <div class="thumbnails">
                <img class="thumbnail" src="../item images/pen image/MUJI 0.5mm Smooth Black Ink Pen/1.jpeg" alt="Thumbnail 1" onclick="selectImage(0)">
                <img class="thumbnail" src="../item images/pen image/MUJI 0.5mm Smooth Black Ink Pen/2.jpeg" alt="Thumbnail 2" onclick="selectImage(1)">
                <img class="thumbnail" src="../item images/pen image/MUJI 0.5mm Smooth Black Ink Pen/3.jpeg" alt="Thumbnail 3" onclick="selectImage(2)">
                <img class="thumbnail" src="../item images/pen image/MUJI 0.5mm Smooth Black Ink Pen/4.jpeg" alt="Thumbnail 4" onclick="selectImage(3)">
            </div>
		
			<!-- Main image -->
			<div class="main-image">
				<img id="main-image" src="../item images/pen image/MUJI 0.5mm Smooth Black Ink Pen/1.jpeg" alt="item-image" class="item-image" onclick="openModal()">
        ...
        <div class="item-info">
            <h1>MUJI 0.5mm Smooth Black Ink Pen</h1>
            <div class="price">RM 1.99</div>
            <div class="discounted-price">RM 1.09</div>
            ...
            <div class="item-options">
                ...
                <div class="row">
                    ...
                    <div class="options" id="options">
                        <img id="black" src="../item images/pen image/MUJI 0.5mm Smooth Black Ink Pen/1.jpeg" alt="black" data-color="black" data-variant-id="29"
                            onclick="changeImage('../item images/pen image/MUJI 0.5mm Smooth Black Ink Pen/1.jpeg', 'black')">
                    </div>
			...
			<br>
            <button class="add-to-cart">ADD TO CART | RM 1.09</button>
			<br><br>
            <div class="info-tabs">
            ...
            <div class="info-content">
                <div id="description-column" class="info-column">
                    <h3>Description:</h3>
                    <ul>
                        <li> Specifications : 1pcs </li>
                        <li> Line Width: 0.7mm </li>
                    </ul>
					<h3>Selling Point:</h3>
					<ol>
                        <li> Super smooth- low viscosity ink </li>
                        <li> Triangular barrel for comfrotable hold. </li>
                    </ol>
                </div>
