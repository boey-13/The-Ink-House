...
<head>
    ...
    <script>
		let images = [
			"../item images/pencil case image/Corduroy Pen Case/1.webp",
			"../item images/pencil case image/Corduroy Pen Case/2.jpeg",
			"../item images/pencil case image/Corduroy Pen Case/3.jpeg",
			"../item images/pencil case image/Corduroy Pen Case/beige.jpeg",
			"../item images/pencil case image/Corduroy Pen Case/black.jpeg",
			"../item images/pencil case image/Corduroy Pen Case/blue.jpeg",
			"../item images/pencil case image/Corduroy Pen Case/gray.jpeg",
			"../item images/pencil case image/Corduroy Pen Case/pink.jpeg"
		];
	...
	<script>
		...
		function loadReviews() {
			...
			const savedReviews = JSON.parse(localStorage.getItem('corduroyPenCase_reviews')) || [];
		...
		function saveReview(reviewHTML) {
			...
			localStorage.setItem('corduroyPenCase_reviews', JSON.stringify(savedReviews));
		}
    ...
    <div class="container">
        <div class="item-images">
            ...
            <div class="thumbnails">
                <img class="thumbnail" src="../item images/pencil case image/Corduroy Pen Case/1.webp" alt="Thumbnail 1" onclick="selectImage(0)">
                <img class="thumbnail" src="../item images/pencil case image/Corduroy Pen Case/2.jpeg" alt="Thumbnail 2" onclick="selectImage(1)">
                <img class="thumbnail" src="../item images/pencil case image/Corduroy Pen Case/3.jpeg" alt="Thumbnail 3" onclick="selectImage(2)">
                <img class="thumbnail" src="../item images/pencil case image/Corduroy Pen Case/beige.jpeg" alt="Thumbnail 4" onclick="selectImage(3)">
                <img class="thumbnail" src="../item images/pencil case image/Corduroy Pen Case/black.jpeg" alt="Thumbnail 5" onclick="selectImage(4)">
                <img class="thumbnail" src="../item images/pencil case image/Corduroy Pen Case/blue.jpeg" alt="Thumbnail 6" onclick="selectImage(5)">
                <img class="thumbnail" src="../item images/pencil case image/Corduroy Pen Case/gray.jpeg" alt="Thumbnail 7" onclick="selectImage(6)">
                <img class="thumbnail" src="../item images/pencil case image/Corduroy Pen Case/pink.jpeg" alt="Thumbnail 8" onclick="selectImage(7)">
            </div>
		
			<!-- Main image -->
			<div class="main-image">
				<img id="main-image" src="../item images/pencil case image/Corduroy Pen Case/1.webp" alt="item-image" class="item-image" onclick="openModal()">
        ...
        <div class="item-info">
            <h1>Corduroy Pen Case</h1>
            <div class="price">RM 12.90</div>
            <div class="discounted-price">RM 10.90</div>
            ...
            <div class="item-options">
                ...
                <div class="row">
                    ...
                    <div class="options" id="options">
                        <img id="beige" src="../item images/pencil case image/Corduroy Pen Case/beige.jpeg" alt="beige" data-color="Beige" data-variant-id="31"
                            onclick="changeImage('../item images/pencil case image/Corduroy Pen Case/beige.jpeg', 'Beige')">
						<img id="black" src="../item images/pencil case image/Corduroy Pen Case/black.jpeg" alt="black" data-color="Black" data-variant-id="32"
                            onclick="changeImage('../item images/pencil case image/Corduroy Pen Case/black.jpeg', 'Black')">
						<img id="blue" src="../item images/pencil case image/Corduroy Pen Case/blue.jpeg" alt="blue" data-color="Blue" data-variant-id="33"
                            onclick="changeImage('../item images/pencil case image/Corduroy Pen Case/blue.jpeg', 'Blue')">
						<img id="gray" src="../item images/pencil case image/Corduroy Pen Case/gray.jpeg" alt="gray" data-color="Gray" data-variant-id="34"
                            onclick="changeImage('../item images/pencil case image/Corduroy Pen Case/gray.jpeg', 'Gray')">
						<img id="pink" src="../item images/pencil case image/Corduroy Pen Case/pink.jpeg" alt="pink" data-color="Pink" data-variant-id="35"
                            onclick="changeImage('../item images/pencil case image/Corduroy Pen Case/pink.jpeg', 'Pink')">
                    </div>
			...
			<br>
            <button class="add-to-cart">ADD TO CART | RM 10.90</button>
			<br><br>
            <div class="info-tabs">
