...
<head>
    ...
    <script>
		let images = [
			"../item images/sticker image/54pcs Pink Raspberry Sour Horn Sticker/1.webp",
			"../item images/sticker image/54pcs Pink Raspberry Sour Horn Sticker/2.webp",
			"../item images/sticker image/54pcs Pink Raspberry Sour Horn Sticker/3.jpeg",
			"../item images/sticker image/54pcs Pink Raspberry Sour Horn Sticker/4.jpeg",
			"../item images/sticker image/54pcs Pink Raspberry Sour Horn Sticker/5.jpeg"
		];
	...
	<script>
		...
		function loadReviews() {
			...
			const savedReviews = JSON.parse(localStorage.getItem('raspberrySticker_reviews')) || [];
		...
		function saveReview(reviewHTML) {
			...
			localStorage.setItem('raspberrySticker_reviews', JSON.stringify(savedReviews));
		}
    ...
    <div class="container">
        <div class="item-images">
            ...
            <div class="thumbnails">
                <img class="thumbnail" src="../item images/sticker image/54pcs Pink Raspberry Sour Horn Sticker/1.webp" alt="Thumbnail 1" onclick="selectImage(0)">
                <img class="thumbnail" src="../item images/sticker image/54pcs Pink Raspberry Sour Horn Sticker/2.webp" alt="Thumbnail 2" onclick="selectImage(1)">
                <img class="thumbnail" src="../item images/sticker image/54pcs Pink Raspberry Sour Horn Sticker/3.jpeg" alt="Thumbnail 3" onclick="selectImage(2)">
                <img class="thumbnail" src="../item images/sticker image/54pcs Pink Raspberry Sour Horn Sticker/4.jpeg" alt="Thumbnail 4" onclick="selectImage(3)">
                <img class="thumbnail" src="../item images/sticker image/54pcs Pink Raspberry Sour Horn Sticker/5.jpeg" alt="Thumbnail 5" onclick="selectImage(4)">
            </div>
		
			<!-- Main image -->
			<div class="main-image">
				<img id="main-image" src="../item images/sticker image/54pcs Pink Raspberry Sour Horn Sticker/1.webp" alt="item-image" class="item-image" onclick="openModal()">
        ...
        <div class="item-info">
            <h1>54pcs Pink Raspberry Sour Horn Sticker </h1>
            <div class="price">RM 3.50</div>
            <div class="discounted-price">RM 2.98</div>
            ...
            <div class="item-options">
                ...
                <div class="row">
                    ...
                    <div class="options" id="options">
                        <img id="1" src="../item images/sticker image/54pcs Pink Raspberry Sour Horn Sticker/2.webp" alt="1" data-color="One variation" data-variant-id="53"
                            onclick="changeImage('../item images/sticker image/54pcs Pink Raspberry Sour Horn Sticker/2.webp', 'One variation')">
                    </div>
			...
			<br>
            <button class="add-to-cart">ADD TO CART | RM 2.98</button>
			<br><br>
            <div class="info-tabs">
            ...
            <div class="info-content">
                <div id="description-column" class="info-column">
                    ...
                    <ul>
                        <li> Size: 4-6 cm (1.57-2.37 inches) </li>
                        <li> Material: High quality washi paper</li>
                        <li> Packaging: OPP </li>
