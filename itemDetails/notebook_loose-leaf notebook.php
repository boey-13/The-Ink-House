...
<head>
    ...
    <script>
		let images = [
			"../item images/notebook image/Loose-leaf Notebook/1.jpeg",
			"../item images/notebook image/Loose-leaf Notebook/2.jpeg",
			"../item images/notebook image/Loose-leaf Notebook/3.jpeg",
			"../item images/notebook image/Loose-leaf Notebook/4.jpeg"
		];
	...
	<script>
		...
		function loadReviews() {
			...
			const savedReviews = JSON.parse(localStorage.getItem('looseLeafNotebook_reviews')) || [];
		...
		function saveReview(reviewHTML) {
			...
			localStorage.setItem('looseLeafNotebook_reviews', JSON.stringify(savedReviews));
		}
    ...
    <div class="container">
        <div class="item-images">
            ...
            <div class="thumbnails">
                <img class="thumbnail" src="../item images/notebook image/Loose-leaf Notebook/1.jpeg" alt="Thumbnail 1" onclick="selectImage(0)">
                <img class="thumbnail" src="../item images/notebook image/Loose-leaf Notebook/2.jpeg" alt="Thumbnail 2" onclick="selectImage(1)">
                <img class="thumbnail" src="../item images/notebook image/Loose-leaf Notebook/3.jpeg" alt="Thumbnail 3" onclick="selectImage(2)">
                <img class="thumbnail" src="../item images/notebook image/Loose-leaf Notebook/4.jpeg" alt="Thumbnail 4" onclick="selectImage(3)">
            </div>
		
			<!-- Main image -->
			<div class="main-image">
				<img id="main-image" src="../item images/notebook image/Loose-leaf Notebook/1.jpeg" alt="item-image" class="item-image" onclick="openModal()">
            ...
            <div class="item-options">
                ...
                <div class="row">
                    ...
                    <div class="options" id="options">
                        <img id="leaf" src="../item images/notebook image/Loose-leaf Notebook/1.jpeg" alt="leaf" data-color="Leaf" data-variant-id="7"
                            onclick="changeImage('../item images/notebook image/Loose-leaf Notebook/1.jpeg', 'One variation')">
                    </div>
